...
namespace Library {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class booksDataTable : global::System.Data.TypedTableBase<booksRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public booksRow AddbooksRow(string Title, string Author, string Genre, string Status, System.DateTime date_insert, System.DateTime date_update, System.DateTime date_delete, int LocationId, string image) {
...
namespace Library.DataSet1TableAdapters {
    ...
    public partial class booksTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[books] ([Title], [Author], [Genre], [Status], [date_insert], [date_update], [date_delete], [LocationId], [image]) VALUES (@Title, @Author, @Genre, @Status, @date_insert, @date_update, @date_delete, @LocationId, @image);
SELECT Id, Title, Author, Genre, Status, date_insert, date_update, date_delete, LocationId, image FROM books WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[books] SET [Title] = @Title, [Author] = @Author, [Genre] = @Genre, [Status] = @Status, [date_insert] = @date_insert, [date_update] = @date_update, [date_delete] = @date_delete, [LocationId] = @LocationId, [image] = @image WHERE (([Id] = @Original_Id) AND ([Title] = @Original_Title) AND ([Author] = @Original_Author) AND ([Genre] = @Original_Genre) AND ([Status] = @Original_Status) AND ([date_insert] = @Original_date_insert) AND ((@IsNull_date_update = 1 AND [date_update] IS NULL) OR ([date_update] = @Original_date_update)) AND ((@IsNull_date_delete = 1 AND [date_delete] IS NULL) OR ([date_delete] = @Original_date_delete)) AND ((@IsNull_LocationId = 1 AND [LocationId] IS NULL) OR ([LocationId] = @Original_LocationId)));
SELECT Id, Title, Author, Genre, Status, date_insert, date_update, date_delete, LocationId, image FROM books WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Title, Author, Genre, Status, date_insert, date_update, date_delete, L" +
                "ocationId, image FROM dbo.books";
        ...
        public virtual int Delete(int Original_Id, string Original_Title, string Original_Author, string Original_Genre, string Original_Status, System.DateTime Original_date_insert, global::System.Nullable<global::System.DateTime> Original_date_update, global::System.Nullable<global::System.DateTime> Original_date_delete, global::System.Nullable<int> Original_LocationId) {
            ...
            this.Adapter.DeleteCommand.Parameters[5].Value = ((System.DateTime)(Original_date_insert));
            if ((Original_date_update.HasValue == true)) {
                this.Adapter.DeleteCommand.Parameters[6].Value = ((object)(0));
                this.Adapter.DeleteCommand.Parameters[7].Value = ((System.DateTime)(Original_date_update.Value));
            }
            else {
            ...
            if ((Original_date_delete.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[9].Value = ((System.DateTime)(Original_date_delete.Value));
            }
            else {
        ...
        public virtual int Insert(string Title, string Author, string Genre, string Status, System.DateTime date_insert, global::System.Nullable<global::System.DateTime> date_update, global::System.Nullable<global::System.DateTime> date_delete, global::System.Nullable<int> LocationId, string image) {
            if ((Title == null)) {
        ...
        public virtual int Update(
            ...
            this.Adapter.UpdateCommand.Parameters[14].Value = ((System.DateTime)(Original_date_insert));
            if ((Original_date_update.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[15].Value = ((object)(0));
                this.Adapter.UpdateCommand.Parameters[16].Value = ((System.DateTime)(Original_date_update.Value));
            }
            else {
            ...
            if ((Original_date_delete.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[18].Value = ((System.DateTime)(Original_date_delete.Value));
            }
            else {
        ...
        public virtual int Update(
                    ...
                    global::System.Nullable<global::System.DateTime> Original_date_delete, 
                    global::System.Nullable<int> Original_LocationId) {
            return this.Update(Title, Author, Genre, Status, date_insert, date_update, date_delete, LocationId, image, Original_Id, Original_Title, Original_Author, Original_Genre, Original_Status, Original_date_insert, Original_date_update, Original_date_delete, Original_LocationId, Original_Id);
        }
    }
